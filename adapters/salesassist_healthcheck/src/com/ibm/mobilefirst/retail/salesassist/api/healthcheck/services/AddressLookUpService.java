package com.ibm.mobilefirst.retail.salesassist.api.healthcheck.services;
...
import com.ibm.mobilefirst.retail.salesassist.adapter.healthcheck.common.ErrorConstants;
import com.ibm.mobilefirst.retail.salesassist.adapter.healthcheck.common.ErrorResponse;
import com.ibm.mobilefirst.retail.salesassist.adapter.healthcheck.common.ServiceConstants;
import com.ibm.mobilefirst.retail.salesassist.api.healthcheck.javabeans.addresslookup.AddresslookupResponse;
import com.ibm.mobilefirst.retail.salesassist.api.healthcheck.javabeans.addresslookup.Data;
import com.ibm.mobilefirst.retail.salesassist.api.healthcheck.javabeans.addresslookup.Error;
	...
	public String getAddressLookup(String postCode) {
		...
		try {
			...
			if(response.getMessageBody()!= null && 
				...
				ArrayList<com.ibm.mobilefirst.retail.salesassist.api.healthcheck.javabeans.addresslookup.Address> addressArray = 
						new ArrayList<com.ibm.mobilefirst.retail.salesassist.api.healthcheck.javabeans.addresslookup.Address>();
				
				for(Address address : addresses) {
					com.ibm.mobilefirst.retail.salesassist.api.healthcheck.javabeans.addresslookup.Address currentAddress = 
							new  com.ibm.mobilefirst.retail.salesassist.api.healthcheck.javabeans.addresslookup.Address();
