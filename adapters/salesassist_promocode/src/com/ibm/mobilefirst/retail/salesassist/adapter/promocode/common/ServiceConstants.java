package com.ibm.mobilefirst.retail.salesassist.adapter.promocode.common;
...
//	public static final String CARTSELF = "/cart/@self?responseFormat=";
	public static final String PROMO_ASSIGNED = "/cart/@self/assigned_promotion_code";
	public static final String ORDERSTATUS = "orderStatus";
	public static final String ERROR_PROMO_REMOVAL="promocode that you want to delete doesn't exist.";
	public static final String PROMO_NOT_FOUND="promocode not found.";
