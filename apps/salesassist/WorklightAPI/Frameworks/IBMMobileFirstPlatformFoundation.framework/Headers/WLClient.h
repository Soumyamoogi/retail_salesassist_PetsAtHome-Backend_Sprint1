...
/***
 * Network call to MobileFirst Server to associate a 'friendly name' with the current device
 * @param friendlyName A string that defines the friendly name being set for the device.
 * @param completionHandler A completion handler to be called at the end of the request.
 */
...
/***
 * Network call to MobileFirst Server to retrieve the 'friendly name' associated with the device.
 * @param completionHandler A completion handler to be called at the end of the request, an object with the friendly name will be passed. 
 */
